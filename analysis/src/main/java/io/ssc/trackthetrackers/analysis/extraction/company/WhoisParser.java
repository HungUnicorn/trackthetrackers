...
public class WhoisParser {
	...
	public final String IANA_WHOIS_SERVER = "whois.iana.org";
	public final int WHOIS_PORT = 43;

	private void printResults(String server, String results) {
	...
	private String parseAdminOrgOfDomain(String whoisResult) {
	...
	public void getFullResult(String host) throws Exception {
